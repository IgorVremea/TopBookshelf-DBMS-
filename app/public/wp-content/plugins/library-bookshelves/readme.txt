...
= 5.10 =
* Fixed Bookshelf initialization script loading order errors that can occur with some themes.
* Fixed image alt text escaping issue.

= 5.9 =
* Fixed XSS security issue.
* Fixed Syndetics image URLs to allow placeholder images for items with no cover art.
