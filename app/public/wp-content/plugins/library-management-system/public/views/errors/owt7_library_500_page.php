...
<div class="owt7-lms">
    <div class="error-500-container">
        <h1>500 - <?php esc_html_e('Internal Server Error', 'library-management-system'); ?></h1>
        <p><?php esc_html_e('Sorry, something went wrong on our end.', 'library-management-system'); ?></p>
